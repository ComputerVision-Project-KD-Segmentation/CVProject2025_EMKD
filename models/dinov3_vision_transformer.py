# ref : https://github.com/ricklisz/MedDINOv3
...
# nnUNet/nnunetv2/training/nnUNetTrainer/dinov3/dinov3/layers/block.py
...
# MedDINOv3/nnUNet/nnunetv2/training/nnUNetTrainer/dinov3/dinov3/utils/utils.py
...
# nnUNet/nnunetv2/training/nnUNetTrainer/dinov3/dinov3/layers/layer_scale.py
...
# nnUNet/nnunetv2/training/nnUNetTrainer/dinov3/dinov3/layers/patch_embed.py
...
class Primus_Multiscale(AbstractDynamicNetworkArchitectures):
    ...
    def forward(self, x, ret_mask=False):
        ...
        low = torch.cat(hier[2], dim=1)
        high = torch.cat(hier[3:], dim=1)
