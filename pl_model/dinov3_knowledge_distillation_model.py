...
class Dinov3KnowledgeDistillationPLModel(BasePLModel):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # loss_imd = importance_maps_distillation(low, t_low)
        # loss_rad = region_affinity_distillation(low, t_low, mask)
        ...
        self.log('train_bkd', bkd_loss, on_step=False, on_epoch=True, prog_bar=True)
        self.log('train_hd', hd_loss, on_step=False, on_epoch=True, prog_bar=True)
